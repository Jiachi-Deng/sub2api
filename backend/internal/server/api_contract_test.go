		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "TanStarter",
					...
					service.SettingKeySiteName:     "TanStarter",
		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"site_name": "TanStarter",
					"site_logo": "",
					"site_subtitle": "Build access for Sim Desktop and Sim Design",
					"api_base_url": "",
					"api_key_acl_trust_forwarded_ip": false,
					"contact_info": "",
					"doc_url": "",
