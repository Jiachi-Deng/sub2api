...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    name: 'BillingSession',
    component: () => import('@/views/user/BillingSessionView.vue'),
    meta: {
      requiresAuth: false,
      requiresAdmin: false,
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/billing-session', '/key-usage', '/setup', '/payment/result', '/payment/airwallex', '/legal']
